...
new_local_repository(
  name = "eigen_archive",
  path = "/home/parsa/tensorflow/deps/eigen_archive",
  build_file = "eigen.BUILD",
)
...
local_repository(
  name = "re2",
  path = "//home/parsa/tensorflow/deps/re2",
)
...
new_local_repository(
  name = "jpeg_archive",
  path = "/home/parsa/tensorflow/deps/jpeg-9a",
  build_file = "jpeg.BUILD",
)
...
new_local_repository(
  name = "png_archive",
  path = "/home/parsa/tensorflow/deps/libpng-1.2.53",
  build_file = "png.BUILD",
)
